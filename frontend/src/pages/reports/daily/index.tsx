                      ...
                      <td className="ps-4 py-3">
                        <div className="d-flex align-items-center gap-3">
                          ...
                          <div>
                            ...
                            <Badge bg={report.shift === 'DIA' ? 'warning' : 'info'} className="x-tiny text-dark fw-black tracking-widest">{report.shift}</Badge>
                          </div>
                        </div>
                      </td>
                      <td>
        ...
        <Modal show={templateModalOpen} onHide={() => setTemplateModalOpen(false)} centered contentClassName="border-0 shadow-2xl rounded-4">
          ...
          <Form onSubmit={handleTemplateUpload}>
            <Modal.Body className="p-4 bg-card">
              ...
              <div className="mt-3 p-3 bg-primary bg-opacity-5 rounded-3 border border-primary border-opacity-10">
        ...
        <Modal show={!!previewReport} onHide={() => setPreviewReport(null)} size="lg" scrollable centered contentClassName="border-0 shadow-2xl rounded-4">
          ...
          <Modal.Body className="p-0 bg-card">
            <div className="p-3 bg-surface border-bottom d-flex gap-2 align-items-center px-4">
              <Badge bg="primary" className="bg-opacity-10 text-primary border border-primary border-opacity-10 fw-black px-2">{previewReport?.date}</Badge>
              <Badge bg="dark" className="bg-opacity-50 text-white border border-white border-opacity-10 text-uppercase fw-black px-2">{previewReport?.shift}</Badge>
