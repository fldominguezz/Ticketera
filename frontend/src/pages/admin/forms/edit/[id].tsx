                        ...
                        <Col lg={8}>
                            <Card className="border-0 shadow-sm mb-4">
                                ...
                                <Card.Body className="p-4">
                                    ...
                                    <div className="mt-4 p-4 border-2 border-dashed border-opacity-10 rounded text-center text-muted small fw-bold">Arrastra o añade elementos de la paleta</div>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col lg={4}>
