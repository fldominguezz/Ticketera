                ...
                <Col lg={8}>
                    <Card className="border-0 shadow-sm mb-4">
                        <div className="p-3 bg-surface-muted border-bottom border-color d-flex justify-content-between align-items-center">
                            ...
                            <Badge bg="primary" className="bg-opacity-10 text-primary border border-primary border-opacity-10">STANDARD PRO</Badge>
                        </div>
                        <Card.Body className="p-4">
                            <Form onSubmit={handleSave}>
                                ...
                                <div className="bg-primary bg-opacity-5 p-3 rounded border border-primary border-opacity-10 mb-4">
                                    <Form.Check 
                                        type="switch" 
