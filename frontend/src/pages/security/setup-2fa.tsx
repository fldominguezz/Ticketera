    ...
    <Layout title="Configurar 2FA">
      <Container className="py-4">
        <div className="max-width-md mx-auto">
          <Button variant="link" onClick={() => router.push('/profile')} className="p-0 mb-4 text-dark text-decoration-none">
            ...
            <Card.Body className="p-4 p-md-5">
              ...
              {step === 3 && (
                <div className="text-center">
                  ...
                  <div className="bg-dark text-success p-4 rounded mb-4 text-start">
