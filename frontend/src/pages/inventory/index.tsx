      ...
      <div className="inventory-container p-3 p-lg-4">
        ...
        <Offcanvas show={showFilters} onHide={() => setShowFilters(false)} placement="end" className="bg-card text-main border-start border-color">
          ...
          <Offcanvas.Body className="p-4 bg-card">
            <Form>
              ...
              <div className="mt-5 p-3 rounded-3 bg-primary bg-opacity-5 border border-primary border-opacity-10 text-center">
        ...
        <Card className="border-0 shadow-sm rounded-4 overflow-hidden bg-card">
          <Card.Body className="p-0 position-relative">
            ...
            <div className={`bulk-actions-bar bg-primary text-white transition-all overflow-hidden ${selectedAssets.size > 0 ? 'py-2 px-4' : 'h-0 opacity-0'}`} style={{ maxHeight: selectedAssets.size > 0 ? '60px' : '0' }}>
                <div className="d-flex justify-content-between align-items-center">
                    <div className="d-flex align-items-center gap-3">
                        ...
                        <Button variant="link" className="text-white p-0 x-small fw-bold text-decoration-none opacity-75 hover-opacity-100" onClick={() => setSelectedAssets(new Set())}>DESELECCIONAR</Button>
                    </div>
            ...
            <div className="table-responsive bg-surface">
