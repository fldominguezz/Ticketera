...
const ReactQuill = dynamic(loadQuillBasic, { 
  ssr: false, 
  loading: () => <div className="bg-light border rounded animate-pulse" style={{ height: '250px' }} />
});
...
const RichTextEditor: React.FC<Props> = ({ value, onChange, placeholder }) => {
  ...
  if (!mounted) return <div className="bg-light border rounded" style={{ height: '250px' }} />;
