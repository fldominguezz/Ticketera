    ...
    <div className="comment-item mb-4 animate-fade-in">
      <div className="d-flex justify-content-between align-items-center mb-2">
        <div className="d-flex align-items-center gap-2">
           ...
           <span className="small fw-black text-white uppercase tracking-tighter">
      ...
      <div className="comment-bubble p-3 bg-black bg-opacity-20 rounded-lg border border-white border-opacity-5">
        <div 
