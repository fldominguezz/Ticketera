...
class AIService:
    ...
    async def suggest_remediation(self, title: str, description: str) -> str:
        prompt = f"""
        Eres un experto en respuesta a incidentes (Incident Responder).
        Proporciona una lista de pasos técnicos de remediación en ESPAÑOL para el siguiente incidente.
        Sé específico y directo.
        
        Incidente: {title}
        Detalles técnicos: {description}
        ...
        try:
            ...
            return "1. Aislar el equipo afectado de la red.\n2. Iniciar escaneo forense de memoria.\n3. Bloquear IoCs en el Firewall/EDR."
